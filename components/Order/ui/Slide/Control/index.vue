<template>
  <section class="order-info-control">
    <order-create-ui-pagination :page="page" />
    <transition-group name="scroll">
      <div v-if="page === 1" class="order-info-control__description">
        <order-create-ui-filters
          class="order-info-control__filter-form"
        ...
        <order-create-ui-description
          class="order-info-control__description-form"
          :init-data="orderData"
          @next-page="nextPage"
        />
      </div>
      <div v-if="page === 2" class="order-info-control__parameters">
      ...
      <div v-if="page === 3" class="order-info-control__publish">
